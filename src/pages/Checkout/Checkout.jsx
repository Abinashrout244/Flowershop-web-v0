    ...
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      <div className="max-w-5xl mx-auto px-4 py-3">
        <div className="flex items-center gap-2 text-xs text-gray-400">
          <Link to="/cart" className="hover:text-[#c9a87c]">
            Cart
          </Link>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16">
        <h1 className="font-serif-display text-3xl font-light text-gray-900 mb-8">
          Checkout
        </h1>
          ...
          {steps.map((s, i) => (
            <div key={s} className="flex items-center flex-1 last:flex-none">
              <div className="flex flex-col items-center">
                ...
                <p
                  className={`text-xs font-semibold mt-1.5 ${i === step ? "text-[#c9a87c]" : "text-gray-400"}`}
                >
                  {s}
                </p>
              </div>
              {i < steps.length - 1 && (
                <div
                  className={`flex-1 h-0.5 mx-2 mb-5 transition-all duration-500 ${i < step ? "bg-emerald-400" : "bg-gray-200"}`}
                />
              )}
            </div>
          ))}
          ...
          <div className="lg:col-span-2">
            ...
            {step === 2 && (
              <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm space-y-5">
                <h2 className="font-serif-display text-2xl font-light text-gray-900">
                  Review Your Order
                </h2>
                ...
                <div className="bg-[#fdf8f0] rounded-2xl p-4 flex gap-3">
                  <MapPin
                    size={18}
                    className="text-[#c9a87c] flex-shrink-0 mt-0.5"
                  />
                  <div>
                    <p className="font-semibold text-sm text-gray-800">
          ...
          <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm h-fit sticky top-24">
            ...
            <div className="border-t border-gray-100 pt-3 space-y-2 text-sm">
              ...
              <div className="flex justify-between text-gray-500">
                ...
                <span
                  className={
                    deliveryFee === 0 ? "text-emerald-600 font-semibold" : ""
                  }
                >
