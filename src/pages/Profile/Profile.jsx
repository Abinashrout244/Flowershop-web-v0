        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#c9a87c] font-semibold tracking-widest uppercase mt-1">
                {user.since}
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {activeTab === 0 && (
              <div>
                <h2 className="font-serif-display text-2xl font-light text-gray-900 mb-5">
                  My Orders
                </h2>
                {orders.length === 0 ? (
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 text-center">
                    <Package size={40} className="text-gray-300 mx-auto mb-3" />
                    <p className="font-serif-display text-xl font-light text-gray-500 mb-2">
                      No orders yet
                    </p>
                    ...
                    <Link
                      to="/flowers"
                      className="inline-block px-8 py-3 bg-[#c9a87c] text-white text-sm font-bold rounded-full hover:bg-[#b8966b] transition-colors"
                    >
                      Shop Now
                    </Link>
                  </div>
                      ...
                      >
                        <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                          <div>
                            ...
                            <p className="font-bold text-gray-900 font-serif-display">
                              {order.id}
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="font-bold text-[#c9a87c]">
                        ...
                        <div className="flex flex-wrap gap-3">
                          {order.items?.slice(0, 3).map((item, i) => (
                            <div
                              key={i}
                              className="flex items-center gap-2 bg-[#fdf8f0] rounded-xl px-3 py-2"
                            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white rounded-2xl border-2 border-[#c9a87c] shadow-sm p-5">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-xs font-bold bg-[#c9a87c] text-white px-2.5 py-1 rounded-full tracking-widest uppercase">
                        Home
                      </span>
                      <button className="text-xs text-[#c9a87c] font-semibold hover:underline">
                        Edit
                      </button>
                    </div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                      12, Rose Garden Apartments, MG Road, Mumbai - 400001,
                      Maharashtra
                    </p>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    {[
                      ...
                      <label
                        key={pref}
                        className="flex items-center justify-between py-2.5 border-b border-gray-50 cursor-pointer group"
                      >
