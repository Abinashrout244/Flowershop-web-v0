...
const Hero = () => {
    ...
    if (!document.getElementById("fleur-kf")) {
      ...
      st.textContent = `
        ...
        @media (min-width: 480px) and (max-width: 767px) {
          .hero-stat-num  { font-size: 17px !important; }
          .hero-stat-lbl  { font-size: 8.5px !important; }
          .hero-stat-cell { padding: 14px 8px !important; }
        }
      `;
  ...
  useEffect(() => {
    ...
    const drawBg = () => {
      ...
      if (light) {
        ...
        g.addColorStop(0, "rgba(255,235,210,0.85)");
        g.addColorStop(0.5, "rgba(255,245,230,0.4)");
        ...
        g2.addColorStop(0, "rgba(255,200,210,0.25)");
        ...
        g3.addColorStop(0, "rgba(201,168,124,0.15)");
        ...
        g.addColorStop(0, "rgba(55,38,10,0.6)");
        g.addColorStop(0.5, "rgba(28,18,5,0.35)");
        g.addColorStop(1, "transparent");
        ctx.fillStyle = g;
        ctx.fillRect(0, 0, W, H);
        const g2 = ctx.createRadialGradient(
        ...
        g2.addColorStop(0, "rgba(224,185,106,0.06)");
        g2.addColorStop(1, "transparent");
        ctx.fillStyle = g2;
        ctx.fillRect(0, 0, W, H);
      }
  ...
  useEffect(() => {
    ...
    petalsRef.current = Array.from(
      { length: 100 },
      () => new Petal(r.width, r.height, true, !isDark),
    );
    bloomsRef.current = [];
  }, [isDark]);
  ...
  const T = isDark
    ? {
        ...
        eyeLine: "rgba(224,185,106,0.55)",
        titleColor: "#fdf8f0",
        titleGold: "#e0b96a",
        divLine: "rgba(224,185,106,0.3)",
        divDot: "rgba(224,185,106,0.5)",
        sub: "rgba(253,248,240,0.52)",
        accent: "#e0b96a",
        btnGoldBg: "#e0b96a",
        btnGoldBgHover: "#f0cc88",
        btnGoldColor: "#1a1005",
        btnOutlineBorder: "rgba(253,248,240,0.26)",
        btnOutlineBorderHover: "rgba(253,248,240,0.55)",
        btnOutlineColor: "rgba(253,248,240,0.62)",
        btnOutlineColorHover: "rgba(253,248,240,0.95)",
        btnOutlineBgHover: "rgba(253,248,240,0.06)",
        tagColor: "rgba(253,248,240,0.3)",
        tagColorActive: "#1a1005",
        tagBorder: "rgba(253,248,240,0.1)",
        tagHoverColor: "rgba(253,248,240,0.65)",
        tagHoverBorder: "rgba(224,185,106,0.45)",
        statsBarBg: "rgba(10,6,3,0.55)",
        statsBarBorder: "rgba(224,185,106,0.1)",
        statDivider: "rgba(224,185,106,0.08)",
        statN: "#e0b96a",
        statNHover: "#f5d080",
        statL: "rgba(253,248,240,0.32)",
        statLHover: "rgba(253,248,240,0.6)",
    ...
    : {
        ...
        tagColor: "rgba(80,50,25,0.4)",
        tagColorActive: "#fff8f2",
        tagBorder: "rgba(80,50,25,0.12)",
        tagHoverColor: "rgba(80,50,25,0.8)",
        tagHoverBorder: "rgba(201,168,124,0.6)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap opacity-0 animate-[fleurUp_0.8s_1.1s_ease_forwards] pb-5">
          <button
            ...
            style={{
              ...
              transform:
                btnHover === "gold" ? "translateY(-2px)" : "translateY(0)",
              boxShadow:
                btnHover === "gold" ? `0 6px 20px ${T.accent}44` : "none",
          ...
          <button
            ...
            style={{
              ...
              transform:
                btnHover === "outline" ? "translateY(-2px)" : "translateY(0)",
              transition: "all 0.25s ease",
            }}
        ...
        {/* Tags */}
        {/* <div className="flex items-center justify-center flex-wrap gap-2  md:pt-4 md:pb-2 opacity-0 animate-[fleurUp_0.8s_1.35s_ease_forwards]">
          {TAGS.map((t) => {
      ...
      >
        <span
          ...
          style={{
            color: scrollHover ? T.scrollTxtHover : T.scrollTxt,
